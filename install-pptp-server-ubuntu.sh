...
#    copy from: https://raw.githubusercontent.com/viljoviitanen/setup-simple-pptp-vpn/master/setup.sh
#    copy version: 72a8fc9  on 2 Sep
#    note:
#        A: Only one vpn account is generated. To add more accounts, see the file /etc/ppp/chap-secrets
#        B: You can also specify you own username and password, run sh setup.sh -h for help.
